...
module.exports = class extends AirPurifier.with(
	...
	constructor(options) {
		...
		// State for Changeable LED brightness Brightness: {'value': 0, 'description': 'brightest'}, {'value': 1, 'description': 'glimmer'}, {'value': 2, 'description': 'led_closed'}
		this.defineProperty(
		...
		// State for Switchable LED capability Switch Status: {'value': true, 'description': 'led on'}, {'value': false, 'description': 'led off'}
		this.defineProperty(
